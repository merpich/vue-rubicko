...
<template>
	<div class="px-6 py-4 grid gap-1 bg-white shadow rounded-2xl">
		<RouterLink class="text-blue-600 font-medium hover:underline focus-visible:underline outline-none" :to="url">
			{{ title }}
		</RouterLink>
		<div class="flex justify-between">
			...
			<button class="-mx-4 -my-2 py-2 px-4 flex items-center gap-2 hover:bg-slate-200 focus-visible:bg-slate-200 transition-colors outline-none rounded-2xl" @click="like">
